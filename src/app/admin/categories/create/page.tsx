...
export default function CategoryCreatePage() {
    ...
    const mutationCreate = useMutation({
        mutationFn: async (data: any) => {
            const url = URL_CONTROLLER.replace(':controller', 'categories')
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Tạo danh mục mới" />
            <ComponentCard title="Thông tin danh mục">
                ...
                <Form form={form} layout="vertical" onFinish={mutationCreate.mutate}>
                    ...
                    <Form.Item>
                        <Button type="primary" htmlType="submit">Tạo danh mục mới</Button>
                    </Form.Item>
                </Form>
            </ComponentCard>
        </div>
